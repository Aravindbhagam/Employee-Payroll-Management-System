  ...
  await prisma.$transaction(
    overrides.map((o) =>
      prisma.userPermission.upsert({
        where: { userId_resource_action: { userId: user.id, resource: o.resource, action: o.action } },
        update: { allowed: o.allowed },
        create: { userId: user.id, resource: o.resource, action: o.action, allowed: o.allowed },
      })
    )
  );
